...
<template>
  <div class="flex h-full flex-col overflow-hidden bg-muted/30">
    <GTabs v-model="tab" class="flex min-h-0 flex-1 gap-0">
      <div class="border-b border-border px-4 pt-2 sm:px-6">
        <GTabsList class="bg-transparent p-0">
          <GTabsTrigger value="live" class="gap-1.5">
            <ZapIcon class="size-4" />
            Tiempo Real
          </GTabsTrigger>
          <GTabsTrigger value="hist" class="gap-1.5">
      ...
      <GTabsContent value="live" class="min-h-0 flex-1 overflow-y-auto p-4 sm:p-6">
      ...
      <GTabsContent value="hist" class="min-h-0 flex-1 overflow-y-auto bg-background">
        <GeneracionView />
      </GTabsContent>
    </GTabs>
  </div>
